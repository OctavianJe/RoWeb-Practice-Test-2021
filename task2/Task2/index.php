...
<html>
    ...
    <body>
        ...
        <!-- TODO: Associate CRUD with website -->

        <!-- Initial
        <div class='container-fluid case-section-container'></div>
            <div class="row">
                <div class="three-row-desc-background">
                    <div class='container'>
                        <div class='three-row-desc-section'>
                            <div>
                                <div class="col-md-4">
                                    <img class="img-responsive" src="images/240_1.jpg"/>
                                    <h4>MILESTONE</h4>
                                    <h5>Taleb school system tacking 8000 students</h5>
                                    <p>In hac habitasse platea dictumst.<br/>Vivamus adipiscing farmentum quam volutpat aliquam...</p>                                   
                                </div>
                            </div>

                            <div>
                                <div class="col-md-4">
                                    <img class="img-responsive" src="images/240_2.jpg"/>
                                    <h4>MILESTONE</h4>
                                    <h5>Alcochem applying vision technology to count flies demo</h5>
                                    <p>Curabitur lobortis id lorem id bibendum. Ut id consectetur magna. Quisque volutpat...</p>                                   
                                </div>
                            </div>
                            
                            <div>
                                <div class="col-md-4">	
                                    <img class="img-responsive" src="images/240_3.jpg"/>
                                    <h4>REFLOW LABS</h4>
                                    <h5>Indoor location services for wayfinding hospital</h5>
                                    <p>Vestibulum rutrum quam vitae fringilla tincidunt. Suspendisse nec tortor urna. Ut laoreet sod...</p>                                   
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class='container-fluid full-blue-row'>
            <!-- Aici completeaza HTML -->
            <div class='row'>
                <div class='container'>
                    <div>
                        <div class="col-md-10">	
                            <h2>Check how we can kickstart your smart projects</h2>                                   
                        </div>                                                             
                    </div>
